...
def test_the_four_directions_are_the_ones_asked_for():
    assert KEYS == ["magnetic", "human", "storyteller", "authority"]
...
def test_a_complete_rights_record_passes(tmp_path):
    ...
    assert check.check_rights(tmp_path, "magnetic") == []
